"""
    Part of this code was adapted from Hyperbolic Hierarchical Clustering (https://github.com/HazyResearch/HypHC)
    and Riemannian adam optimizer geoopt implementation (https://github.com/geoopt/).
"""
